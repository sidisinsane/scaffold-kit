...
if __name__ == "__main__":
    ...
    regex_list = [
        processor.pattern_to_regex(pattern) for pattern in pattern_list
    ]

    table = PrettyTable()
    table.add_column("pattern", pattern_list)
    table.add_column("description", description_list)
    table.add_column("regex", regex_list)
    table.align = "l"
