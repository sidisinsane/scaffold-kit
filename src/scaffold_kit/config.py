...
SCAFFOLD_FILE = config.get("scaffold_file", "default.yaml")
"""Constant signifying scaffold file config."""  # pylint: disable=W0105

IGNORE_FILE = config.get("ignore_file", ".gitignore")
...
CHECKLIST_FILE = config.get("checklist_file", "checklist.txt")
...
TREE_FILE = config.get("tree_file", "default-tree.txt")
...
if __name__ == "__main__":
    ...
    constant_table.field_names = ["constant", "value"]
    constant_table.add_rows(constant_nested_list)
    constant_table.align = "l"
